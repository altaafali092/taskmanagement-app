...
const Index = ({ auth, projects, queryParams = null, flash = {} }) => {
                            ...
                            <table className='w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400'>
                                ...
                                <tbody>
                                    {projects.data.map((project, idx) => (
                                        <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-600' key={project.id}>
                                            <td className='px-3 py-2'>{idx+1}</td>
                                            <td className='px-3 py-2'><img src={project.image} className='h-20 w-30' alt="Project" /></td>
                                            <td className='px-3 py-2 hover:underline text-white'>
                                                <Link href={route('project.show', project)} >{project.name}</Link>
                                            </td>
                                            ...
                                            <td className='px-3 py-2'>
                                                <Link href={route('project.edit', project)} className='font-medium text-blue-600 dark:text-blue-500 hover:underlin mx-1 rounded-lg'>Edit</Link>
                                                <Button onClick={(e) => deleteProject(project)} className='font-medium text-red-600
